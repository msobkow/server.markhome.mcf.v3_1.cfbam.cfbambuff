// Description: Java 25 implementation of a DateCol history buffer object
...
public class CFBamBuffDateColH extends CFBamBuffDateDefH
    implements ICFBamDateColH
{
	protected CFLibDbKeyHash256 requiredTableId;

    public CFBamBuffDateColH() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamBuffDateColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
