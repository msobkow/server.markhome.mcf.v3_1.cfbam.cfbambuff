// Description: Java 25 implementation of a NumberDef history buffer object
...
public class CFBamBuffNumberDefH extends CFBamBuffAtomH
    implements ICFBamNumberDefH
{
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamNumberDef) {
            ICFBamNumberDef rhs = (ICFBamNumberDef)obj;
        if (!super.equals(obj)) {
            return( false );
        }
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffNumberDef ) {
			setNumberDef( (CFBamBuffNumberDef)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamNumberDefH ) {
			setNumberDef( (ICFBamNumberDefH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffNumberDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
