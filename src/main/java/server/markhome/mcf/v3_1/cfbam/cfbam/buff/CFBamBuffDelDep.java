// Description: Java 25 implementation of a DelDep buffer
	...
	implements ICFBamDelDep
{
	...
	public void set( ICFBamScope src ) {
		if( src instanceof CFBamBuffDelDep ) {
			setDelDep( (CFBamBuffDelDep)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffDelDep" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
