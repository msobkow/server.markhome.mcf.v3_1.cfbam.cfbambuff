...
// Description: Java 25 Default Factory implementation for UInt64Def buffers
...
/*
 *	CFBamBuffUInt64DefFactory implementation of ICFBamUInt64DefFactory for UInt64Def
 */
public class CFBamBuffUInt64DefDefaultFactory
	implements ICFBamUInt64DefFactory
{
	public CFBamBuffUInt64DefDefaultFactory() {
	}

	@Override
	public ICFBamUInt64Def newRec() {
		ICFBamUInt64Def rec =
			new CFBamBuffUInt64Def();
		return( rec );
	}

	public CFBamBuffUInt64Def ensureRec(ICFBamUInt64Def rec) {
		if( rec == null ) {
			return( null );
		}
