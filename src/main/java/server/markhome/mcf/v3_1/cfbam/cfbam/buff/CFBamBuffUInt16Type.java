// Description: Java 25 implementation of a UInt16Type buffer
	...
	implements ICFBamUInt16Type
{
	...
	public String toString() {
		String ret = "<CFBamBuffUInt16Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
