// Description: Java 25 implementation of a TZDateCol by TableIdx index key buffer
...
public class CFBamBuffTZDateColByTableIdxKey
	implements ICFBamTZDateColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamBuffTZDateColByTableIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffTZDateColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
