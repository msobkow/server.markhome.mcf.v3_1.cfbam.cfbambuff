// Description: Java 25 implementation of a Int16Col buffer
	...
	implements ICFBamInt16Col
{
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffInt16Col ) {
			setInt16Col( (CFBamBuffInt16Col)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffInt16Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
