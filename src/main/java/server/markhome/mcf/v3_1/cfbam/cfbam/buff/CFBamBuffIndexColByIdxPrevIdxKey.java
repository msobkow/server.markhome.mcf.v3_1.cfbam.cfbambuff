// Description: Java 25 implementation of a IndexCol by IdxPrevIdx index key buffer
...
public class CFBamBuffIndexColByIdxPrevIdxKey
	implements ICFBamIndexColByIdxPrevIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredIndexId;
	protected CFLibDbKeyHash256 optionalPrevId;
	public CFBamBuffIndexColByIdxPrevIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffIndexColByIdxPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
