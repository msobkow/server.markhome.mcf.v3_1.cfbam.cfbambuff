// Description: Java 25 implementation of a StringType buffer
	...
	implements ICFBamStringType
{
	...
	public String toString() {
		String ret = "<CFBamBuffStringType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
