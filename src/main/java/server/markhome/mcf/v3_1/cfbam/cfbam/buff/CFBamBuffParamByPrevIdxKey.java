// Description: Java 25 implementation of a Param by PrevIdx index key buffer
...
public class CFBamBuffParamByPrevIdxKey
	implements ICFBamParamByPrevIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalPrevId;
	public CFBamBuffParamByPrevIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffParamByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
