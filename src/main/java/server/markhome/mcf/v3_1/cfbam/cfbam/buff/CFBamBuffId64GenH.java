// Description: Java 25 implementation of a Id64Gen history buffer object
...
public class CFBamBuffId64GenH extends CFBamBuffInt64TypeH
    implements ICFBamId64GenH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffId64Gen ) {
			setId64Gen( (CFBamBuffId64Gen)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffId64GenH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
