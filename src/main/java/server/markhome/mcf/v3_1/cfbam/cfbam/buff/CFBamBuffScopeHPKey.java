// Description: Java 25 implementation of a Scope history buffer primary key
...
/**
 *	CFBamBuffScopeHPKey History Primary Key for Scope
 *		requiredId	Required object attribute Id.
 */
public class CFBamBuffScopeHPKey
	implements ICFBamScopeHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffScopeHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
