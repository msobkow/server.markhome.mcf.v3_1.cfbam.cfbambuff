...
// Description: Java 25 Default Factory implementation for NmTokensCol buffers
...
/*
 *	CFBamBuffNmTokensColFactory implementation of ICFBamNmTokensColFactory for NmTokensCol
 */
public class CFBamBuffNmTokensColDefaultFactory
	implements ICFBamNmTokensColFactory
{
	public CFBamBuffNmTokensColDefaultFactory() {
	}

	@Override
	public ICFBamNmTokensColByTableIdxKey newByTableIdxKey() {
		ICFBamNmTokensColByTableIdxKey key =
			new CFBamBuffNmTokensColByTableIdxKey();
		return( key );
	}
