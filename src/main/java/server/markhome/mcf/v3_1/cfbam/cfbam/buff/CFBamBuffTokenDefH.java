// Description: Java 25 implementation of a TokenDef history buffer object
...
public class CFBamBuffTokenDefH extends CFBamBuffAtomH
    implements ICFBamTokenDefH
{
	protected int requiredMaxLen;
	protected String optionalInitValue;

    public CFBamBuffTokenDefH() {
            super();
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamTokenDef) {
            ICFBamTokenDef rhs = (ICFBamTokenDef)obj;
        if (!super.equals(obj)) {
            return( false );
        }
        ...
        else if (obj instanceof ICFBamTokenDefH) {
			if (!super.equals(obj)) {
				return( false );
			}
            ICFBamTokenDefH rhs = (ICFBamTokenDefH)obj;
        if (!super.equals(obj)) {
            return( false );
        }
			if( getRequiredMaxLen() != rhs.getRequiredMaxLen() ) {
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTokenDef ) {
			setTokenDef( (CFBamBuffTokenDef)src );
		}
		else {
	...
	@Override
    public void setTokenDef( ICFBamTokenDef src ) {
        super.setAtom( src );
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamTokenDefH ) {
			setTokenDef( (ICFBamTokenDefH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
    public void setTokenDef( ICFBamTokenDefH src ) {
        super.setAtom( src );
		setRequiredMaxLen( src.getRequiredMaxLen() );
		setOptionalInitValue( src.getOptionalInitValue() );
    }
    ...
    public String toString() {
        String ret = "<CFBamBuffTokenDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
