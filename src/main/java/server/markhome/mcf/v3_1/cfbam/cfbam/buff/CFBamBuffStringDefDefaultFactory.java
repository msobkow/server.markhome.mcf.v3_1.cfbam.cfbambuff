...
// Description: Java 25 Default Factory implementation for StringDef buffers
...
/*
 *	CFBamBuffStringDefFactory implementation of ICFBamStringDefFactory for StringDef
 */
public class CFBamBuffStringDefDefaultFactory
	implements ICFBamStringDefFactory
{
	public CFBamBuffStringDefDefaultFactory() {
	}

	@Override
	public ICFBamStringDef newRec() {
		ICFBamStringDef rec =
			new CFBamBuffStringDef();
		return( rec );
	}
