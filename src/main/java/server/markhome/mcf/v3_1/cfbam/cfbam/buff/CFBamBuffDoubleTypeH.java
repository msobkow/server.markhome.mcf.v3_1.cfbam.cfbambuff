// Description: Java 25 implementation of a DoubleType history buffer object
...
public class CFBamBuffDoubleTypeH extends CFBamBuffDoubleDefH
    implements ICFBamDoubleTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffDoubleTypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDoubleType ) {
			setDoubleType( (CFBamBuffDoubleType)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDoubleTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
