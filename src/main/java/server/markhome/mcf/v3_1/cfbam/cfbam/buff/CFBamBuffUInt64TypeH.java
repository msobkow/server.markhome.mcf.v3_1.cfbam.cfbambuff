// Description: Java 25 implementation of a UInt64Type history buffer object
...
public class CFBamBuffUInt64TypeH extends CFBamBuffUInt64DefH
    implements ICFBamUInt64TypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffUInt64TypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffUInt64Type ) {
			setUInt64Type( (CFBamBuffUInt64Type)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffUInt64TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
