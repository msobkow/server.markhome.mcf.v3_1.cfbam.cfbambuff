// Description: Java 25 implementation of a DbKeyHash160Col history buffer object
...
public class CFBamBuffDbKeyHash160ColH extends CFBamBuffDbKeyHash160DefH
    implements ICFBamDbKeyHash160ColH
{
	protected CFLibDbKeyHash256 requiredTableId;

    public CFBamBuffDbKeyHash160ColH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDbKeyHash160Col ) {
			setDbKeyHash160Col( (CFBamBuffDbKeyHash160Col)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDbKeyHash160ColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
