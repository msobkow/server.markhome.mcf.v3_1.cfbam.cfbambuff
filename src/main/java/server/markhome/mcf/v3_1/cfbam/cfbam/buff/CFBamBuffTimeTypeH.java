// Description: Java 25 implementation of a TimeType history buffer object
...
public class CFBamBuffTimeTypeH extends CFBamBuffTimeDefH
    implements ICFBamTimeTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffTimeTypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTimeType ) {
			setTimeType( (CFBamBuffTimeType)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffTimeTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
