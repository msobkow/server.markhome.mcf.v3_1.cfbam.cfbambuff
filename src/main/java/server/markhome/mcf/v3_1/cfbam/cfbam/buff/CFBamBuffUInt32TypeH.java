// Description: Java 25 implementation of a UInt32Type history buffer object
...
public class CFBamBuffUInt32TypeH extends CFBamBuffUInt32DefH
    implements ICFBamUInt32TypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffUInt32TypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffUInt32Type ) {
			setUInt32Type( (CFBamBuffUInt32Type)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffUInt32TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
