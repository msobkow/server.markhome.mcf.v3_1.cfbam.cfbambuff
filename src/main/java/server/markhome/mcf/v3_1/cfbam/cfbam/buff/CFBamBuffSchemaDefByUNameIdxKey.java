// Description: Java 25 implementation of a SchemaDef by UNameIdx index key buffer
...
public class CFBamBuffSchemaDefByUNameIdxKey
	implements ICFBamSchemaDefByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffSchemaDefByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
