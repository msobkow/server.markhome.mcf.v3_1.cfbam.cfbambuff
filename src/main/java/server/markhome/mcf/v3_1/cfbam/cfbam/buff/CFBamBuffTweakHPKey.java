// Description: Java 25 implementation of a Tweak history buffer primary key
...
/**
 *	CFBamBuffTweakHPKey History Primary Key for Tweak
 *		requiredId	Required object attribute Id.
 */
public class CFBamBuffTweakHPKey
	implements ICFBamTweakHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFBamTweakPKey, ICFBamTweak, ICFBamTweakHPKey, ICFBamTweakH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamBuffTweakHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
