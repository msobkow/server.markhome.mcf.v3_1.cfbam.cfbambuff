// Description: Java 25 implementation of a Index by UNameIdx index key buffer
...
public class CFBamBuffIndexByUNameIdxKey
	implements ICFBamIndexByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	protected String requiredName;
	public CFBamBuffIndexByUNameIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffIndexByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
