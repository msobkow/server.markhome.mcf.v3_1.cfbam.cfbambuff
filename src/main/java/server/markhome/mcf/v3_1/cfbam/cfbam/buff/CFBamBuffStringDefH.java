// Description: Java 25 implementation of a StringDef history buffer object
...
public class CFBamBuffStringDefH extends CFBamBuffAtomH
    implements ICFBamStringDefH
{
    ...
    public String toString() {
        String ret = "<CFBamBuffStringDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
