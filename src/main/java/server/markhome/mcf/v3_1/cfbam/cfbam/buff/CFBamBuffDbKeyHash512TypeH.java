// Description: Java 25 implementation of a DbKeyHash512Type history buffer object
...
public class CFBamBuffDbKeyHash512TypeH extends CFBamBuffDbKeyHash512DefH
    implements ICFBamDbKeyHash512TypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffDbKeyHash512TypeH() {
            super();
		requiredSchemaDefId = CFLibDbKeyHash256.fromHex( ICFBamDbKeyHash512Type.SCHEMADEFID_INIT_VALUE.toString() );
    }
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDbKeyHash512Type ) {
			setDbKeyHash512Type( (CFBamBuffDbKeyHash512Type)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDbKeyHash512TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
