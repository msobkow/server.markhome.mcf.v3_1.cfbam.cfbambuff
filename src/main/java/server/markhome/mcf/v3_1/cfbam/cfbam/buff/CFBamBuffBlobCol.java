// Description: Java 25 implementation of a BlobCol buffer
	...
	implements ICFBamBlobCol
{
	...
	public String toString() {
		String ret = "<CFBamBuffBlobCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
