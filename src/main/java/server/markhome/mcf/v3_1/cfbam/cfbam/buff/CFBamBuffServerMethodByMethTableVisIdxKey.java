// Description: Java 25 implementation of a ServerMethod by MethTableVisIdx index key buffer
	...
	implements ICFBamServerMethodByMethTableVisIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffServerMethodByMethTableVisIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
