...
// Description: Java 25 Default Factory implementation for TZTimeType buffers
...
/*
 *	CFBamBuffTZTimeTypeFactory implementation of ICFBamTZTimeTypeFactory for TZTimeType
 */
public class CFBamBuffTZTimeTypeDefaultFactory
	implements ICFBamTZTimeTypeFactory
{
	public CFBamBuffTZTimeTypeDefaultFactory() {
	}

	@Override
	public ICFBamTZTimeTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamTZTimeTypeBySchemaIdxKey key =
			new CFBamBuffTZTimeTypeBySchemaIdxKey();
		return( key );
	}
