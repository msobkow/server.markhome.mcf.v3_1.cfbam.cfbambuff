...
// Description: Java 25 Default Factory implementation for EnumDef buffers
...
/*
 *	CFBamBuffEnumDefFactory implementation of ICFBamEnumDefFactory for EnumDef
 */
public class CFBamBuffEnumDefDefaultFactory
	implements ICFBamEnumDefFactory
{
	public CFBamBuffEnumDefDefaultFactory() {
	}

	@Override
	public ICFBamEnumDef newRec() {
		ICFBamEnumDef rec =
			new CFBamBuffEnumDef();
		return( rec );
	}
