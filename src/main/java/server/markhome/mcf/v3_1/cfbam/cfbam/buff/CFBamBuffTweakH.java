// Description: Java 25 implementation of a Tweak history buffer object
...
public class CFBamBuffTweakH
    implements ICFBamTweakH, Comparable<Object>, Serializable
{
    protected CFBamBuffTweakHPKey pkey;
    ...
    @Override
    public ICFBamTweakHPKey getPKey() {
        return( pkey );
    }

    @Override
    public void setPKey( ICFBamTweakHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFBamBuffTweakHPKey) {
                this.pkey = (CFBamBuffTweakHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFBamBuffTweakHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFBamBuffTweakH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
