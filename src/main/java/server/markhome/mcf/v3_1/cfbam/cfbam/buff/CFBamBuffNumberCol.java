// Description: Java 25 implementation of a NumberCol buffer
	...
	implements ICFBamNumberCol
{
	...
	public String toString() {
		String ret = "<CFBamBuffNumberCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
