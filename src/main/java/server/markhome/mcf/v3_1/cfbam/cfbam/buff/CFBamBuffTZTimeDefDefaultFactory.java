...
// Description: Java 25 Default Factory implementation for TZTimeDef buffers
...
/*
 *	CFBamBuffTZTimeDefFactory implementation of ICFBamTZTimeDefFactory for TZTimeDef
 */
public class CFBamBuffTZTimeDefDefaultFactory
	implements ICFBamTZTimeDefFactory
{
	public CFBamBuffTZTimeDefDefaultFactory() {
	}

	@Override
	public ICFBamTZTimeDef newRec() {
		ICFBamTZTimeDef rec =
			new CFBamBuffTZTimeDef();
		return( rec );
	}

	public CFBamBuffTZTimeDef ensureRec(ICFBamTZTimeDef rec) {
		if( rec == null ) {
			return( null );
		}
	...
	public ICFBamTZTimeDefH newHRec() {
		ICFBamTZTimeDefH hrec =
			new CFBamBuffTZTimeDefH();
		return( hrec );
	}
