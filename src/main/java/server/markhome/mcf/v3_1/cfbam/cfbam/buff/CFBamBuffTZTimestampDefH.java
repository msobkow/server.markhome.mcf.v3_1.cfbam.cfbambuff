// Description: Java 25 implementation of a TZTimestampDef history buffer object
...
public class CFBamBuffTZTimestampDefH extends CFBamBuffAtomH
    implements ICFBamTZTimestampDefH
{
	protected String optionalDummy;

    public CFBamBuffTZTimestampDefH() {
            super();
		optionalDummy = null;
    }
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTZTimestampDef ) {
			setTZTimestampDef( (CFBamBuffTZTimestampDef)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffTZTimestampDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
