// Description: Java 25 implementation of a DoubleDef history buffer object
...
public class CFBamBuffDoubleDefH extends CFBamBuffAtomH
    implements ICFBamDoubleDefH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDoubleDef ) {
			setDoubleDef( (CFBamBuffDoubleDef)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDoubleDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
