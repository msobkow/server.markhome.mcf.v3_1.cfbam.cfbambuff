// Description: Java 25 implementation of a DoubleCol buffer
...
public class CFBamBuffDoubleCol
	...
	implements ICFBamDoubleCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDoubleCol ) {
			ICFBamDoubleCol rhs = (ICFBamDoubleCol)obj;
		...
		else if( obj instanceof ICFBamDoubleColH ) {
			ICFBamDoubleColH rhs = (ICFBamDoubleColH)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamDoubleColByTableIdxKey ) {
			ICFBamDoubleColByTableIdxKey rhs = (ICFBamDoubleColByTableIdxKey)obj;
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDoubleCol ) {
			setDoubleCol( (CFBamBuffDoubleCol)src );
		}
		else {
	...
	public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamDoubleColH ) {
			setDoubleCol( (ICFBamDoubleColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	public String toString() {
		String ret = "<CFBamBuffDoubleCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
