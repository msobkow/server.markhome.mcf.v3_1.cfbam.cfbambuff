// Description: Java 25 implementation of a DbKeyHash128Def history buffer object
...
public class CFBamBuffDbKeyHash128DefH extends CFBamBuffAtomH
    implements ICFBamDbKeyHash128DefH
{
	protected String optionalInitValue;

    public CFBamBuffDbKeyHash128DefH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDbKeyHash128Def ) {
			setDbKeyHash128Def( (CFBamBuffDbKeyHash128Def)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDbKeyHash128DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
