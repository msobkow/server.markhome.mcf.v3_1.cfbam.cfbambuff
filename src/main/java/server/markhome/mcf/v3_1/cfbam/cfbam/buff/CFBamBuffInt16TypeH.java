// Description: Java 25 implementation of a Int16Type history buffer object
...
public class CFBamBuffInt16TypeH extends CFBamBuffInt16DefH
    implements ICFBamInt16TypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffInt16TypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffInt16Type ) {
			setInt16Type( (CFBamBuffInt16Type)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffInt16TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
