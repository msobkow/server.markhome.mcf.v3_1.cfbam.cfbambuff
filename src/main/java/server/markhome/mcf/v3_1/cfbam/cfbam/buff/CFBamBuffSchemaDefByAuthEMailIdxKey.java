// Description: Java 25 implementation of a SchemaDef by AuthEMailIdx index key buffer
...
public class CFBamBuffSchemaDefByAuthEMailIdxKey
	implements ICFBamSchemaDefByAuthEMailIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffSchemaDefByAuthEMailIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
