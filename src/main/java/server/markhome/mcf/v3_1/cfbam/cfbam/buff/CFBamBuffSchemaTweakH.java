// Description: Java 25 implementation of a SchemaTweak history buffer object
...
public class CFBamBuffSchemaTweakH extends CFBamBuffTweakH
    implements ICFBamSchemaTweakH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffSchemaTweakH() {
            super();
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamSchemaTweak) {
            ICFBamSchemaTweak rhs = (ICFBamSchemaTweak)obj;
        if (!super.equals(obj)) {
            return( false );
        }
        ...
        else if (obj instanceof ICFBamSchemaTweakH) {
			if (!super.equals(obj)) {
				return( false );
			}
            ICFBamSchemaTweakH rhs = (ICFBamSchemaTweakH)obj;
        if (!super.equals(obj)) {
            return( false );
        }
			if( getRequiredSchemaDefId() != null ) {
        ...
        else if (obj instanceof ICFBamSchemaTweakBySchemaIdxKey) {
            ICFBamSchemaTweakBySchemaIdxKey rhs = (ICFBamSchemaTweakBySchemaIdxKey)obj;
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
    ...
    public void set( ICFBamTweak src ) {
		if( src instanceof CFBamBuffSchemaTweak ) {
			setSchemaTweak( (CFBamBuffSchemaTweak)src );
		}
		else {
    ...
    public void set( ICFBamTweakH src ) {
		if( src instanceof ICFBamSchemaTweakH ) {
			setSchemaTweak( (ICFBamSchemaTweakH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffSchemaTweakH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
