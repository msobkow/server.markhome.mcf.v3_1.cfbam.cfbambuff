// Description: Java 25 implementation of a TZDateCol history buffer object
...
public class CFBamBuffTZDateColH extends CFBamBuffTZDateDefH
    implements ICFBamTZDateColH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTZDateCol ) {
			setTZDateCol( (CFBamBuffTZDateCol)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffTZDateColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
