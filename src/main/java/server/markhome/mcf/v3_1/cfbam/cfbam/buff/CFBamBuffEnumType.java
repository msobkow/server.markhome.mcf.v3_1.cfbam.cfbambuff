// Description: Java 25 implementation of a EnumType buffer
...
public class CFBamBuffEnumType
	...
	implements ICFBamEnumType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamEnumTypeH ) {
			ICFBamEnumTypeH rhs = (ICFBamEnumTypeH)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffEnumType ) {
			setEnumType( (CFBamBuffEnumType)src );
		}
		else {
	...
	public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamEnumTypeH ) {
			setEnumType( (ICFBamEnumTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	public String toString() {
		String ret = "<CFBamBuffEnumType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
