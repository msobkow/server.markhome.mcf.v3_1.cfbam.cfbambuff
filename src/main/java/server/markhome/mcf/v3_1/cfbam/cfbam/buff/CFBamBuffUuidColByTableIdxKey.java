// Description: Java 25 implementation of a UuidCol by TableIdx index key buffer
...
public class CFBamBuffUuidColByTableIdxKey
	implements ICFBamUuidColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamBuffUuidColByTableIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffUuidColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
