// Description: Java 25 implementation of a StringCol history buffer object
...
public class CFBamBuffStringColH extends CFBamBuffStringDefH
    implements ICFBamStringColH
{
	protected CFLibDbKeyHash256 requiredTableId;

    public CFBamBuffStringColH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffStringCol ) {
			setStringCol( (CFBamBuffStringCol)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffStringColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
