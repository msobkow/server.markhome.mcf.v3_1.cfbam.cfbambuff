// Description: Java 25 implementation of a SchemaDef history buffer object
...
public class CFBamBuffSchemaDefH extends CFBamBuffScopeH
    implements ICFBamSchemaDefH
{
    ...
    public String toString() {
        String ret = "<CFBamBuffSchemaDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
