// Description: Java 25 implementation of a TZTimeDef buffer
	...
	implements ICFBamTZTimeDef
{
	...
	public String toString() {
		String ret = "<CFBamBuffTZTimeDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
