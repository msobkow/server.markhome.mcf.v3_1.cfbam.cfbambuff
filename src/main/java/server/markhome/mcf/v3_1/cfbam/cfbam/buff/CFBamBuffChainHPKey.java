// Description: Java 25 implementation of a Chain history buffer primary key
...
/**
 *	CFBamBuffChainHPKey History Primary Key for Chain
 *		requiredId	Required object attribute Id.
 */
public class CFBamBuffChainHPKey
	implements ICFBamChainHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffChainHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
