...
// Description: Java 25 Default Factory implementation for ClearDep buffers
...
/*
 *	CFBamBuffClearDepFactory implementation of ICFBamClearDepFactory for ClearDep
 */
public class CFBamBuffClearDepDefaultFactory
	implements ICFBamClearDepFactory
{
	public CFBamBuffClearDepDefaultFactory() {
	}

	@Override
	public ICFBamClearDepByClearDepIdxKey newByClearDepIdxKey() {
		ICFBamClearDepByClearDepIdxKey key =
			new CFBamBuffClearDepByClearDepIdxKey();
		return( key );
	}
