// Description: Java 25 implementation of a RoleDef history buffer primary key
...
/**
 *	CFBamBuffRoleDefHPKey History Primary Key for RoleDef
 *		requiredId	Required object attribute Id.
 */
public class CFBamBuffRoleDefHPKey
	implements ICFBamRoleDefHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffRoleDefHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
