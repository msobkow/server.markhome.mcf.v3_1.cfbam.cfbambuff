// Description: Java 25 implementation of a DbKeyHash128Gen buffer
...
public class CFBamBuffDbKeyHash128Gen
	extends CFBamBuffDbKeyHash128Type
	implements ICFBamDbKeyHash128Gen
{
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDbKeyHash128Gen ) {
			setDbKeyHash128Gen( (CFBamBuffDbKeyHash128Gen)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffDbKeyHash128Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
