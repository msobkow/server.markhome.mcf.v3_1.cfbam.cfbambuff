...
// Description: Java 25 Default Factory implementation for Index buffers
...
/*
 *	CFBamBuffIndexFactory implementation of ICFBamIndexFactory for Index
 */
public class CFBamBuffIndexDefaultFactory
	implements ICFBamIndexFactory
{
	public CFBamBuffIndexDefaultFactory() {
	}

	@Override
	public ICFBamIndexByUNameIdxKey newByUNameIdxKey() {
		ICFBamIndexByUNameIdxKey key =
			new CFBamBuffIndexByUNameIdxKey();
		return( key );
	}
