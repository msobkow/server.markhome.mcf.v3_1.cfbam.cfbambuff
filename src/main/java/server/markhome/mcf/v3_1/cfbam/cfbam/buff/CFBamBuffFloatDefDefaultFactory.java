...
// Description: Java 25 Default Factory implementation for FloatDef buffers
...
/*
 *	CFBamBuffFloatDefFactory implementation of ICFBamFloatDefFactory for FloatDef
 */
public class CFBamBuffFloatDefDefaultFactory
	implements ICFBamFloatDefFactory
{
	public CFBamBuffFloatDefDefaultFactory() {
	}

	@Override
	public ICFBamFloatDef newRec() {
		ICFBamFloatDef rec =
			new CFBamBuffFloatDef();
		return( rec );
	}

	public CFBamBuffFloatDef ensureRec(ICFBamFloatDef rec) {
		if( rec == null ) {
			return( null );
		}
