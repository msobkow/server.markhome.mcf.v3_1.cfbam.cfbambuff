// Description: Java 25 implementation of a DbKeyHash224Gen history buffer object
...
public class CFBamBuffDbKeyHash224GenH extends CFBamBuffDbKeyHash224TypeH
    implements ICFBamDbKeyHash224GenH
{
	protected short requiredSlice;
	protected int requiredBlockSize;

    public CFBamBuffDbKeyHash224GenH() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamBuffDbKeyHash224GenH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
