...
// Description: Java 25 Default Factory implementation for PopDep buffers
...
/*
 *	CFBamBuffPopDepFactory implementation of ICFBamPopDepFactory for PopDep
 */
public class CFBamBuffPopDepDefaultFactory
	implements ICFBamPopDepFactory
{
	public CFBamBuffPopDepDefaultFactory() {
	}

	@Override
	public ICFBamPopDepByRelationIdxKey newByRelationIdxKey() {
		ICFBamPopDepByRelationIdxKey key =
			new CFBamBuffPopDepByRelationIdxKey();
		return( key );
	}
