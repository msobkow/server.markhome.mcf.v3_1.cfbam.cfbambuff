// Description: Java 25 implementation of a DbKeyHash128Type history buffer object
...
public class CFBamBuffDbKeyHash128TypeH extends CFBamBuffDbKeyHash128DefH
    implements ICFBamDbKeyHash128TypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffDbKeyHash128TypeH() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamBuffDbKeyHash128TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
