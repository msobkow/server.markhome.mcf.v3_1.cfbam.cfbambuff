...
// Description: Java 25 Default Factory implementation for ServerMethod buffers
...
/*
 *	CFBamBuffServerMethodFactory implementation of ICFBamServerMethodFactory for ServerMethod
 */
public class CFBamBuffServerMethodDefaultFactory
	implements ICFBamServerMethodFactory
{
	public CFBamBuffServerMethodDefaultFactory() {
	}

	@Override
	public ICFBamServerMethodByUNameIdxKey newByUNameIdxKey() {
		ICFBamServerMethodByUNameIdxKey key =
			new CFBamBuffServerMethodByUNameIdxKey();
		return( key );
	}
