...
// Description: Java 25 Default Factory implementation for ServerListFunc buffers
...
/*
 *	CFBamBuffServerListFuncFactory implementation of ICFBamServerListFuncFactory for ServerListFunc
 */
public class CFBamBuffServerListFuncDefaultFactory
	implements ICFBamServerListFuncFactory
{
	public CFBamBuffServerListFuncDefaultFactory() {
	}

	@Override
	public ICFBamServerListFuncByRetTblIdxKey newByRetTblIdxKey() {
		ICFBamServerListFuncByRetTblIdxKey key =
			new CFBamBuffServerListFuncByRetTblIdxKey();
		return( key );
	}
