// Description: Java 25 implementation of a EnumTag history buffer primary key
...
/**
 *	CFBamBuffEnumTagHPKey History Primary Key for EnumTag
 *		requiredId	Required object attribute Id.
 */
public class CFBamBuffEnumTagHPKey
	implements ICFBamEnumTagHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFBamEnumTagPKey, ICFBamEnumTag, ICFBamEnumTagHPKey, ICFBamEnumTagH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamBuffEnumTagHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
