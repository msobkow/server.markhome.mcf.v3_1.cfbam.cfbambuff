// Description: Java 25 implementation of a EnumDef history buffer object
...
public class CFBamBuffEnumDefH extends CFBamBuffInt16DefH
    implements ICFBamEnumDefH
{

    public CFBamBuffEnumDefH() {
            super();
    }
    ...
    public String toString() {
        String ret = "<CFBamBuffEnumDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
