// Description: Java 25 implementation of a TimestampCol history buffer object
...
public class CFBamBuffTimestampColH extends CFBamBuffTimestampDefH
    implements ICFBamTimestampColH
{
	protected CFLibDbKeyHash256 requiredTableId;

    public CFBamBuffTimestampColH() {
            super();
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamTimestampColH) {
			if (!super.equals(obj)) {
				return( false );
			}
            ICFBamTimestampColH rhs = (ICFBamTimestampColH)obj;
        if (!super.equals(obj)) {
            return( false );
        }
			if( getRequiredTableId() != null ) {
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTimestampCol ) {
			setTimestampCol( (CFBamBuffTimestampCol)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamTimestampColH ) {
			setTimestampCol( (ICFBamTimestampColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffTimestampColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
