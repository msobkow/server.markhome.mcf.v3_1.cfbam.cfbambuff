// Description: Java 25 implementation of a ClearTopDep buffer
...
public class CFBamBuffClearTopDep
	...
	implements ICFBamClearTopDep
{
	...
	public ICFBamClearTopDep getOptionalLookupPrev() {
		...
		ICFBamClearTopDep targetRec = targetTable.readDerived(null, getOptionalPrevId());
		return(targetRec);
	}
	@Override
	...
	public ICFBamClearTopDep getOptionalLookupNext() {
		...
		ICFBamClearTopDep targetRec = targetTable.readDerived(null, getOptionalNextId());
		return(targetRec);
	}
	@Override
	...
	public void set( ICFBamScope src ) {
		if( src instanceof CFBamBuffClearTopDep ) {
			setClearTopDep( (CFBamBuffClearTopDep)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffClearTopDep" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
