// Description: Java 25 implementation of a Int64Type buffer
...
public class CFBamBuffInt64Type
	extends CFBamBuffInt64Def
	implements ICFBamInt64Type
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

	public CFBamBuffInt64Type() {
		super();
		requiredSchemaDefId = CFLibDbKeyHash256.fromHex( ICFBamInt64Type.SCHEMADEFID_INIT_VALUE.toString() );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamInt64Type ) {
			ICFBamInt64Type rhs = (ICFBamInt64Type)obj;
		...
		else if( obj instanceof ICFBamInt64TypeH ) {
			ICFBamInt64TypeH rhs = (ICFBamInt64TypeH)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamInt64TypeBySchemaIdxKey ) {
			ICFBamInt64TypeBySchemaIdxKey rhs = (ICFBamInt64TypeBySchemaIdxKey)obj;
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffInt64Type ) {
			setInt64Type( (CFBamBuffInt64Type)src );
		}
		else {
	...
	public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamInt64TypeH ) {
			setInt64Type( (ICFBamInt64TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	public String toString() {
		String ret = "<CFBamBuffInt64Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
