// Description: Java 25 implementation of a FloatDef buffer
...
public class CFBamBuffFloatDef
	...
	implements ICFBamFloatDef
{
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffFloatDef ) {
			setFloatDef( (CFBamBuffFloatDef)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffFloatDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
