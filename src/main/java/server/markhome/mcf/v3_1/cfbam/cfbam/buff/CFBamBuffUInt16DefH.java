// Description: Java 25 implementation of a UInt16Def history buffer object
...
public class CFBamBuffUInt16DefH extends CFBamBuffAtomH
    implements ICFBamUInt16DefH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffUInt16Def ) {
			setUInt16Def( (CFBamBuffUInt16Def)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffUInt16DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
