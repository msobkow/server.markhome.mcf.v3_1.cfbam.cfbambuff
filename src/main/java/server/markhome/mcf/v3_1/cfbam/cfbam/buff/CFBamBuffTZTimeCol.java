// Description: Java 25 implementation of a TZTimeCol buffer
...
public class CFBamBuffTZTimeCol
	...
	implements ICFBamTZTimeCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimeCol ) {
			ICFBamTZTimeCol rhs = (ICFBamTZTimeCol)obj;
		...
		else if( obj instanceof ICFBamTZTimeColH ) {
			ICFBamTZTimeColH rhs = (ICFBamTZTimeColH)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamTZTimeColByTableIdxKey ) {
			ICFBamTZTimeColByTableIdxKey rhs = (ICFBamTZTimeColByTableIdxKey)obj;
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTZTimeCol ) {
			setTZTimeCol( (CFBamBuffTZTimeCol)src );
		}
		else {
	...
	public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamTZTimeColH ) {
			setTZTimeCol( (ICFBamTZTimeColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	public String toString() {
		String ret = "<CFBamBuffTZTimeCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
