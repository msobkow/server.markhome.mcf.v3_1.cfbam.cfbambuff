// Description: Java 25 implementation of a FloatType history buffer object
...
public class CFBamBuffFloatTypeH extends CFBamBuffFloatDefH
    implements ICFBamFloatTypeH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffFloatType ) {
			setFloatType( (CFBamBuffFloatType)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffFloatTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
