// Description: Java 25 implementation of a Value history buffer primary key
...
/**
 *	CFBamBuffValueHPKey History Primary Key for Value
 *		requiredId	Required object attribute Id.
 */
public class CFBamBuffValueHPKey
	implements ICFBamValueHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFBamValuePKey, ICFBamValue, ICFBamValueHPKey, ICFBamValueH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamBuffValueHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
