// Description: Java 25 implementation of a Tweak by UNameIdx index key buffer
...
public class CFBamBuffTweakByUNameIdxKey
	implements ICFBamTweakByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredScopeId;
	protected String requiredName;
	public CFBamBuffTweakByUNameIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffTweakByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
