// Description: Java 25 implementation of a TimestampDef history buffer object
...
public class CFBamBuffTimestampDefH extends CFBamBuffAtomH
    implements ICFBamTimestampDefH
{
	protected String optionalDummy;

    public CFBamBuffTimestampDefH() {
            super();
		optionalDummy = null;
    }
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTimestampDef ) {
			setTimestampDef( (CFBamBuffTimestampDef)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffTimestampDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
