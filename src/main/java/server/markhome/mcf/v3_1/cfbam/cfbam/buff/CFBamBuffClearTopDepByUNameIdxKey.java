// Description: Java 25 implementation of a ClearTopDep by UNameIdx index key buffer
...
public class CFBamBuffClearTopDepByUNameIdxKey
	implements ICFBamClearTopDepByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffClearTopDepByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
