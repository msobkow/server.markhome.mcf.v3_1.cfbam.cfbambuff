// Description: Java 25 implementation of a Relation by ToTblIdx index key buffer
...
public class CFBamBuffRelationByToTblIdxKey
	implements ICFBamRelationByToTblIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffRelationByToTblIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
