// Description: Java 25 implementation of a Id32Gen history buffer object
    ...
    implements ICFBamId32GenH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffId32Gen ) {
			setId32Gen( (CFBamBuffId32Gen)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffId32GenH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
