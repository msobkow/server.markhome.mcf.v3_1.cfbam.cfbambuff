...
// Description: Java 25 Default Factory implementation for DateType buffers
...
/*
 *	CFBamBuffDateTypeFactory implementation of ICFBamDateTypeFactory for DateType
 */
public class CFBamBuffDateTypeDefaultFactory
	implements ICFBamDateTypeFactory
{
	public CFBamBuffDateTypeDefaultFactory() {
	}

	@Override
	public ICFBamDateTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamDateTypeBySchemaIdxKey key =
			new CFBamBuffDateTypeBySchemaIdxKey();
		return( key );
	}
