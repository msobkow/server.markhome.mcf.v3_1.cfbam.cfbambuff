// Description: Java 25 implementation of a TimestampType history buffer object
...
public class CFBamBuffTimestampTypeH extends CFBamBuffTimestampDefH
    implements ICFBamTimestampTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffTimestampTypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTimestampType ) {
			setTimestampType( (CFBamBuffTimestampType)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffTimestampTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
