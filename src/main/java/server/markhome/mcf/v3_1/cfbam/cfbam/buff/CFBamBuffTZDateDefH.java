// Description: Java 25 implementation of a TZDateDef history buffer object
...
public class CFBamBuffTZDateDefH extends CFBamBuffAtomH
    implements ICFBamTZDateDefH
{
	protected String optionalDummy;

    public CFBamBuffTZDateDefH() {
            super();
		optionalDummy = null;
    }
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamTZDateDef) {
            ICFBamTZDateDef rhs = (ICFBamTZDateDef)obj;
        if (!super.equals(obj)) {
            return( false );
        }
        ...
        else if (obj instanceof ICFBamTZDateDefH) {
			if (!super.equals(obj)) {
				return( false );
			}
            ICFBamTZDateDefH rhs = (ICFBamTZDateDefH)obj;
        if (!super.equals(obj)) {
            return( false );
        }
			if( getOptionalDummy() != null ) {
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTZDateDef ) {
			setTZDateDef( (CFBamBuffTZDateDef)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamTZDateDefH ) {
			setTZDateDef( (ICFBamTZDateDefH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffTZDateDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
