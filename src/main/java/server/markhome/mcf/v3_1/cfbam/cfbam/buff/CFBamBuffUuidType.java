// Description: Java 25 implementation of a UuidType buffer
...
public class CFBamBuffUuidType
	extends CFBamBuffUuidDef
	implements ICFBamUuidType
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

	public CFBamBuffUuidType() {
		super();
	...
	public String toString() {
		String ret = "<CFBamBuffUuidType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
