// Description: Java 25 implementation of a NmTokensCol buffer
	...
	implements ICFBamNmTokensCol
{
	...
	public String toString() {
		String ret = "<CFBamBuffNmTokensCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
