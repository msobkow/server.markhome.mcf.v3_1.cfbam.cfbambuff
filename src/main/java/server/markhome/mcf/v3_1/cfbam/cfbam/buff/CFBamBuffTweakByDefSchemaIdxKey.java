// Description: Java 25 implementation of a Tweak by DefSchemaIdx index key buffer
...
public class CFBamBuffTweakByDefSchemaIdxKey
	implements ICFBamTweakByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamBuffTweakByDefSchemaIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffTweakByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
