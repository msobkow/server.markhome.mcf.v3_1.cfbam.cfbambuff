// Description: Java 25 implementation of a Index history buffer object
...
public class CFBamBuffIndexH extends CFBamBuffScopeH
    implements ICFBamIndexH
{
    ...
    public boolean equals( Object obj ) {
        ...
        if (!super.equals(obj)) {
            ...
            ICFBamIndexByUNameIdxKey rhs = (ICFBamIndexByUNameIdxKey)obj;
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
        ...
        else if (obj instanceof ICFBamIndexByIdxTableIdxKey) {
            ICFBamIndexByIdxTableIdxKey rhs = (ICFBamIndexByIdxTableIdxKey)obj;
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
    ...
    public void set( ICFBamScope src ) {
		if( src instanceof CFBamBuffIndex ) {
			setIndex( (CFBamBuffIndex)src );
		}
		else {
    ...
    public void set( ICFBamScopeH src ) {
		if( src instanceof ICFBamIndexH ) {
			setIndex( (ICFBamIndexH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffIndexH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
