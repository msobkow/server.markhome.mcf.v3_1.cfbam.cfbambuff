// Description: Java 25 implementation of a DateDef history buffer object
...
public class CFBamBuffDateDefH extends CFBamBuffAtomH
    implements ICFBamDateDefH
{
	protected String optionalDummy;

    public CFBamBuffDateDefH() {
            super();
		optionalDummy = null;
    }
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDateDef ) {
			setDateDef( (CFBamBuffDateDef)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDateDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
