// Description: Java 25 implementation of a Index by IdxTblCdVisX index key buffer
...
public class CFBamBuffIndexByIdxTblCdVisXKey
	implements ICFBamIndexByIdxTblCdVisXKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffIndexByIdxTblCdVisXKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
