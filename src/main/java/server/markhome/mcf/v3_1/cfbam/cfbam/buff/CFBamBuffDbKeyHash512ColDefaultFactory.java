...
// Description: Java 25 Default Factory implementation for DbKeyHash512Col buffers
...
/*
 *	CFBamBuffDbKeyHash512ColFactory implementation of ICFBamDbKeyHash512ColFactory for DbKeyHash512Col
 */
public class CFBamBuffDbKeyHash512ColDefaultFactory
	implements ICFBamDbKeyHash512ColFactory
{
	public CFBamBuffDbKeyHash512ColDefaultFactory() {
	}

	@Override
	public ICFBamDbKeyHash512ColByTableIdxKey newByTableIdxKey() {
		ICFBamDbKeyHash512ColByTableIdxKey key =
			new CFBamBuffDbKeyHash512ColByTableIdxKey();
		return( key );
	}
