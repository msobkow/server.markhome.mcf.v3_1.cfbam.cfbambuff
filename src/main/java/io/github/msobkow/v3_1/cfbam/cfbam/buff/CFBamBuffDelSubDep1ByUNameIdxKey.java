// Description: Java 25 implementation of a DelSubDep1 by UNameIdx index key buffer
...
public class CFBamBuffDelSubDep1ByUNameIdxKey
	implements ICFBamDelSubDep1ByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredDelTopDepId;
	protected String requiredName;
	public CFBamBuffDelSubDep1ByUNameIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffDelSubDep1ByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
