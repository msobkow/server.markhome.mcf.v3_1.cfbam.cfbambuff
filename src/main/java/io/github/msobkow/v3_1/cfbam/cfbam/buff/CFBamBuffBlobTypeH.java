// Description: Java 25 implementation of a BlobType history buffer object
...
public class CFBamBuffBlobTypeH extends CFBamBuffBlobDefH
    implements ICFBamBlobTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffBlobTypeH() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamBuffBlobTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
