// Description: Java 25 implementation of a ClearSubDep2 history buffer object
...
public class CFBamBuffClearSubDep2H extends CFBamBuffClearDepH
    implements ICFBamClearSubDep2H
{
	protected CFLibDbKeyHash256 requiredClearSubDep1Id;
	protected String requiredName;

    public CFBamBuffClearSubDep2H() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamBuffClearSubDep2H" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
