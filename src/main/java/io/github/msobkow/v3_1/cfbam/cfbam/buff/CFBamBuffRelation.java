// Description: Java 25 implementation of a Relation buffer
...
public class CFBamBuffRelation
	...
	implements ICFBamRelation
{
	...
	public ICFBamIndex getRequiredLookupFromIndex() {
		...
		ICFBamIndex targetRec = targetTable.readDerived(null, getRequiredFromIndexId());
		return(targetRec);
	}
	@Override
	...
	public ICFBamTable getRequiredLookupToTable() {
		...
		ICFBamTable targetRec = targetTable.readDerived(null, getRequiredToTableId());
		return(targetRec);
	}
	@Override
	...
	public ICFBamIndex getRequiredLookupToIndex() {
		...
		ICFBamIndex targetRec = targetTable.readDerived(null, getRequiredToIndexId());
		return(targetRec);
	}
	@Override
	...
	public ICFBamRelation getOptionalLookupNarrowed() {
		...
		ICFBamRelation targetRec = targetTable.readDerived(null, getOptionalNarrowedId());
		return(targetRec);
	}
	@Override
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredToIndexId() != null && !getRequiredToIndexId().isNull() ) {
				if( rhs.getRequiredToIndexId() != null && !rhs.getRequiredToIndexId().isNull() ) {
				...
				if( rhs.getRequiredToIndexId() != null && !getRequiredToIndexId().isNull()) {
					return( false );
				}
			}
	...
	public void set( ICFBamScope src ) {
		if( src instanceof CFBamBuffRelation ) {
			setRelation( (CFBamBuffRelation)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffRelation" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
