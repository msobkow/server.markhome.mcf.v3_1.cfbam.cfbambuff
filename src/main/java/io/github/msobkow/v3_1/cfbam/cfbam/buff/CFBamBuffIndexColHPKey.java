// Description: Java 25 implementation of a IndexCol history buffer primary key
...
/**
 *	CFBamBuffIndexColHPKey History Primary Key for IndexCol
 *		requiredId	Required object attribute Id.
 */
public class CFBamBuffIndexColHPKey
	implements ICFBamIndexColHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexColPKey, ICFBamIndexCol, ICFBamIndexColHPKey, ICFBamIndexColH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamBuffIndexColHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
