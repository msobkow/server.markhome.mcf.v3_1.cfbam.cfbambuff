// Description: Java 25 implementation of a IndexCol history buffer object
...
public class CFBamBuffIndexColH
    implements ICFBamIndexColH, Comparable<Object>, Serializable
{
    ...
    @Override
    public ICFBamIndexColHPKey getPKey() {
        return( pkey );
    }

    @Override
    public void setPKey( ICFBamIndexColHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFBamBuffIndexColHPKey) {
                this.pkey = (CFBamBuffIndexColHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFBamBuffIndexColHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFBamBuffIndexColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
