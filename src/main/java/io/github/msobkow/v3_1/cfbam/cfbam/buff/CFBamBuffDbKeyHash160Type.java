// Description: Java 25 implementation of a DbKeyHash160Type buffer
	...
	implements ICFBamDbKeyHash160Type
{
	...
	public String toString() {
		String ret = "<CFBamBuffDbKeyHash160Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
