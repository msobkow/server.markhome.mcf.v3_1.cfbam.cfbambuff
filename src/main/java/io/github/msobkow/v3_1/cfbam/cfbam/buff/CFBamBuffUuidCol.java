// Description: Java 25 implementation of a UuidCol buffer
	...
	implements ICFBamUuidCol
{
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffUuidCol ) {
			setUuidCol( (CFBamBuffUuidCol)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffUuidCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
