// Description: Java 25 implementation of a Value by NextIdx index key buffer
...
public class CFBamBuffValueByNextIdxKey
	implements ICFBamValueByNextIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalNextId;
	public CFBamBuffValueByNextIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffValueByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
