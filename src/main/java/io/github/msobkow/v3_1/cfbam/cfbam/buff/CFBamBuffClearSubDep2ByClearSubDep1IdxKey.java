// Description: Java 25 implementation of a ClearSubDep2 by ClearSubDep1Idx index key buffer
...
public class CFBamBuffClearSubDep2ByClearSubDep1IdxKey
	implements ICFBamClearSubDep2ByClearSubDep1IdxKey, Comparable<Object>, Serializable
{
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredClearSubDep1Id() != null && !getRequiredClearSubDep1Id().isNull() ) {
				if( rhs.getRequiredClearSubDep1Id() != null && !rhs.getRequiredClearSubDep1Id().isNull() ) {
				...
				if( rhs.getRequiredClearSubDep1Id() != null && !getRequiredClearSubDep1Id().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public String toString() {
		String ret = "<CFBamBuffClearSubDep2ByClearSubDep1IdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
