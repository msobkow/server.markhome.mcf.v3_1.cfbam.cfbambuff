// Description: Java 25 implementation of a TokenCol buffer
	...
	implements ICFBamTokenCol
{
	...
	public String toString() {
		String ret = "<CFBamBuffTokenCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
