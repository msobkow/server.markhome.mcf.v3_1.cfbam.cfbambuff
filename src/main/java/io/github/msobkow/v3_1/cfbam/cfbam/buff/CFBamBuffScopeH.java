// Description: Java 25 implementation of a Scope history buffer object
...
public class CFBamBuffScopeH
    implements ICFBamScopeH, Comparable<Object>, Serializable
{
    protected CFBamBuffScopeHPKey pkey;
    ...
    public CFBamBuffScopeH() {
            // The primary key member attributes are initialized on construction
            pkey = new CFBamBuffScopeHPKey();
    ...
    @Override
    public ICFBamScopeHPKey getPKey() {
        return( pkey );
    }

    @Override
    public void setPKey( ICFBamScopeHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFBamBuffScopeHPKey) {
                this.pkey = (CFBamBuffScopeHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFBamBuffScopeHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFBamBuffScopeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
