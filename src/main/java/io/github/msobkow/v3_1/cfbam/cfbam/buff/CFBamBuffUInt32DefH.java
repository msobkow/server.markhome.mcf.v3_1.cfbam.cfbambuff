// Description: Java 25 implementation of a UInt32Def history buffer object
...
public class CFBamBuffUInt32DefH extends CFBamBuffAtomH
    implements ICFBamUInt32DefH
{
	protected Long optionalInitValue;
	protected Long optionalMinValue;
	protected Long optionalMaxValue;

    public CFBamBuffUInt32DefH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffUInt32Def ) {
			setUInt32Def( (CFBamBuffUInt32Def)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamUInt32DefH ) {
			setUInt32Def( (ICFBamUInt32DefH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffUInt32DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
