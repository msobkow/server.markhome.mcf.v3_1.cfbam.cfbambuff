// Description: Java 25 implementation of a TZTimestampCol buffer
	...
	implements ICFBamTZTimestampCol
{
	...
	public String toString() {
		String ret = "<CFBamBuffTZTimestampCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
