// Description: Java 25 implementation of a NmTokensCol history buffer object
...
public class CFBamBuffNmTokensColH extends CFBamBuffNmTokensDefH
    implements ICFBamNmTokensColH
{
	protected CFLibDbKeyHash256 requiredTableId;

    public CFBamBuffNmTokensColH() {
            super();
		requiredTableId = CFLibDbKeyHash256.fromHex( ICFBamNmTokensCol.TABLEID_INIT_VALUE.toString() );
    }
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamNmTokensCol) {
        ...
        else if (obj instanceof ICFBamNmTokensColH) {
			if (!super.equals(obj)) {
				return( false );
			}
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffNmTokensCol ) {
			setNmTokensCol( (CFBamBuffNmTokensCol)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamNmTokensColH ) {
			setNmTokensCol( (ICFBamNmTokensColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffNmTokensColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
