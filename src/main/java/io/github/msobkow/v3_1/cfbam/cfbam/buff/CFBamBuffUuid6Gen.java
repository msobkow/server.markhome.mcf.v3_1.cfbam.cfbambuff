// Description: Java 25 implementation of a Uuid6Gen buffer
	...
	implements ICFBamUuid6Gen
{
	...
	public String toString() {
		String ret = "<CFBamBuffUuid6Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
