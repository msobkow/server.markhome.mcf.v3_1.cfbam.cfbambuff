// Description: Java 25 implementation of a TimeDef buffer
	...
	implements ICFBamTimeDef
{
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTimeDef ) {
			setTimeDef( (CFBamBuffTimeDef)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffTimeDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
