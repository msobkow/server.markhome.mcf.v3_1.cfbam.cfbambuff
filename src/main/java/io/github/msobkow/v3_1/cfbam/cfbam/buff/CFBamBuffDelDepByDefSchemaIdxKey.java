// Description: Java 25 implementation of a DelDep by DefSchemaIdx index key buffer
...
public class CFBamBuffDelDepByDefSchemaIdxKey
	implements ICFBamDelDepByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamBuffDelDepByDefSchemaIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffDelDepByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
