// Description: Java 25 implementation of a DbKeyHash384Gen history buffer object
...
public class CFBamBuffDbKeyHash384GenH extends CFBamBuffDbKeyHash384TypeH
    implements ICFBamDbKeyHash384GenH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDbKeyHash384Gen ) {
			setDbKeyHash384Gen( (CFBamBuffDbKeyHash384Gen)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDbKeyHash384GenH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
