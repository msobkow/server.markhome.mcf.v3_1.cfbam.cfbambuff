// Description: Java 25 implementation of a PopSubDep2 by UNameIdx index key buffer
...
public class CFBamBuffPopSubDep2ByUNameIdxKey
	implements ICFBamPopSubDep2ByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamBuffPopSubDep2ByUNameIdxKey() {
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredPopSubDep1Id() != null && !getRequiredPopSubDep1Id().isNull() ) {
				if( rhs.getRequiredPopSubDep1Id() != null && !rhs.getRequiredPopSubDep1Id().isNull() ) {
				...
				if( rhs.getRequiredPopSubDep1Id() != null && !getRequiredPopSubDep1Id().isNull()) {
					return( false );
				}
			}
	...
	public String toString() {
		String ret = "<CFBamBuffPopSubDep2ByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
