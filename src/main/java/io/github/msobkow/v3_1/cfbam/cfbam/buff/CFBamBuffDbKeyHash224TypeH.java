// Description: Java 25 implementation of a DbKeyHash224Type history buffer object
...
public class CFBamBuffDbKeyHash224TypeH extends CFBamBuffDbKeyHash224DefH
    implements ICFBamDbKeyHash224TypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffDbKeyHash224TypeH() {
            super();
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamDbKeyHash224Type) {
            ICFBamDbKeyHash224Type rhs = (ICFBamDbKeyHash224Type)obj;
        if (!super.equals(obj)) {
            return( false );
        }
        ...
        else if (obj instanceof ICFBamDbKeyHash224TypeH) {
			if (!super.equals(obj)) {
				return( false );
			}
            ICFBamDbKeyHash224TypeH rhs = (ICFBamDbKeyHash224TypeH)obj;
        if (!super.equals(obj)) {
            return( false );
        }
			if( getRequiredSchemaDefId() != null && !getRequiredSchemaDefId().isNull() ) {
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDbKeyHash224Type ) {
			setDbKeyHash224Type( (CFBamBuffDbKeyHash224Type)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamDbKeyHash224TypeH ) {
			setDbKeyHash224Type( (ICFBamDbKeyHash224TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffDbKeyHash224TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
