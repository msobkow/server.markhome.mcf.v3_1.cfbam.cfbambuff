...
// Description: Java 25 Default Factory implementation for EnumType buffers
...
/*
 *	CFBamBuffEnumTypeFactory implementation of ICFBamEnumTypeFactory for EnumType
 */
public class CFBamBuffEnumTypeDefaultFactory
	implements ICFBamEnumTypeFactory
{
	public CFBamBuffEnumTypeDefaultFactory() {
	}

	@Override
	public ICFBamEnumTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamEnumTypeBySchemaIdxKey key =
			new CFBamBuffEnumTypeBySchemaIdxKey();
		return( key );
	}
