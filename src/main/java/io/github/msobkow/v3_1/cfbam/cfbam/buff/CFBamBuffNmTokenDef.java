// Description: Java 25 implementation of a NmTokenDef buffer
...
public class CFBamBuffNmTokenDef
	...
	implements ICFBamNmTokenDef
{
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffNmTokenDef ) {
			setNmTokenDef( (CFBamBuffNmTokenDef)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffNmTokenDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
