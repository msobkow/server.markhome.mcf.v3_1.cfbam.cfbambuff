// Description: Java 25 implementation of a EnumTag history buffer object
...
public class CFBamBuffEnumTagH
    implements ICFBamEnumTagH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFBamEnumTagHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFBamBuffEnumTagHPKey) {
                this.pkey = (CFBamBuffEnumTagHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFBamBuffEnumTagHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFBamBuffEnumTagH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
