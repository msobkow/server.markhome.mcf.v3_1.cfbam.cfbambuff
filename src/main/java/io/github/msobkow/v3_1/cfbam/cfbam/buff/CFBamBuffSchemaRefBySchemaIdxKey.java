// Description: Java 25 implementation of a SchemaRef by SchemaIdx index key buffer
...
public class CFBamBuffSchemaRefBySchemaIdxKey
	implements ICFBamSchemaRefBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaId;
	public CFBamBuffSchemaRefBySchemaIdxKey() {
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredSchemaId() != null && !getRequiredSchemaId().isNull() ) {
				if( rhs.getRequiredSchemaId() != null && !rhs.getRequiredSchemaId().isNull() ) {
				...
				if( rhs.getRequiredSchemaId() != null && !getRequiredSchemaId().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public String toString() {
		String ret = "<CFBamBuffSchemaRefBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
