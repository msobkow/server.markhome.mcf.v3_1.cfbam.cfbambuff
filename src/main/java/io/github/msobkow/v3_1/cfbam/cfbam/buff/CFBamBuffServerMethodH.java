// Description: Java 25 implementation of a ServerMethod history buffer object
...
public class CFBamBuffServerMethodH extends CFBamBuffScopeH
    implements ICFBamServerMethodH
{
    ...
    public String toString() {
        String ret = "<CFBamBuffServerMethodH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
