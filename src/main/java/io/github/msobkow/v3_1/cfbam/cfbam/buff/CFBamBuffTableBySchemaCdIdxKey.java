// Description: Java 25 implementation of a Table by SchemaCdIdx index key buffer
...
public class CFBamBuffTableBySchemaCdIdxKey
	implements ICFBamTableBySchemaCdIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffTableBySchemaCdIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
