// Description: Java 25 implementation of a EnumDef buffer
...
public class CFBamBuffEnumDef
	extends CFBamBuffInt16Def
	implements ICFBamEnumDef
{
	...
	public List<ICFBamEnumTag> getRequiredComponentsTag() {
		...
		ICFBamEnumTag[] targetArr = targetTable.readDerivedByEnumIdx(null, getRequiredId());
		if( targetArr != null ) {
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffEnumDef ) {
			setEnumDef( (CFBamBuffEnumDef)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffEnumDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
