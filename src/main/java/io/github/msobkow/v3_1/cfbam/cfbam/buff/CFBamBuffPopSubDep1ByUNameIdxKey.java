// Description: Java 25 implementation of a PopSubDep1 by UNameIdx index key buffer
...
public class CFBamBuffPopSubDep1ByUNameIdxKey
	implements ICFBamPopSubDep1ByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredPopTopDepId;
	protected String requiredName;
	public CFBamBuffPopSubDep1ByUNameIdxKey() {
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredPopTopDepId() != null && !getRequiredPopTopDepId().isNull() ) {
				if( rhs.getRequiredPopTopDepId() != null && !rhs.getRequiredPopTopDepId().isNull() ) {
				...
				if( rhs.getRequiredPopTopDepId() != null && !getRequiredPopTopDepId().isNull()) {
					return( false );
				}
			}
	...
	public String toString() {
		String ret = "<CFBamBuffPopSubDep1ByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
