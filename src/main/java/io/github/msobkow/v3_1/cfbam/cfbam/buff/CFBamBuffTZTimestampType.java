// Description: Java 25 implementation of a TZTimestampType buffer
...
public class CFBamBuffTZTimestampType
	extends CFBamBuffTZTimestampDef
	implements ICFBamTZTimestampType
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

	public CFBamBuffTZTimestampType() {
		super();
	...
	public String toString() {
		String ret = "<CFBamBuffTZTimestampType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
