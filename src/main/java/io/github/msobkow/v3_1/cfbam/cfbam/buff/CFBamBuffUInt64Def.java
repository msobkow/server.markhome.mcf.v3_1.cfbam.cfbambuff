// Description: Java 25 implementation of a UInt64Def buffer
...
public class CFBamBuffUInt64Def
	...
	implements ICFBamUInt64Def
{
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffUInt64Def ) {
			setUInt64Def( (CFBamBuffUInt64Def)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamBuffUInt64Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
