// Description: Java 25 implementation of a UuidType history buffer object
...
public class CFBamBuffUuidTypeH extends CFBamBuffUuidDefH
    implements ICFBamUuidTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffUuidTypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffUuidType ) {
			setUuidType( (CFBamBuffUuidType)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffUuidTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
