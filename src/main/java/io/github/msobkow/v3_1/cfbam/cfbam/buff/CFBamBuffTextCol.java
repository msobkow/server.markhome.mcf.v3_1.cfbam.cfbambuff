// Description: Java 25 implementation of a TextCol buffer
	...
	implements ICFBamTextCol
{
	...
	public String toString() {
		String ret = "<CFBamBuffTextCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
