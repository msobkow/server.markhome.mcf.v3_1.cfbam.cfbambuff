...
// Description: Java 25 Default Factory implementation for DbKeyHash224Type buffers
...
/*
 *	CFBamBuffDbKeyHash224TypeFactory implementation of ICFBamDbKeyHash224TypeFactory for DbKeyHash224Type
 */
public class CFBamBuffDbKeyHash224TypeDefaultFactory
	implements ICFBamDbKeyHash224TypeFactory
{
	public CFBamBuffDbKeyHash224TypeDefaultFactory() {
	}

	@Override
	public ICFBamDbKeyHash224TypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamDbKeyHash224TypeBySchemaIdxKey key =
			new CFBamBuffDbKeyHash224TypeBySchemaIdxKey();
		return( key );
	}
