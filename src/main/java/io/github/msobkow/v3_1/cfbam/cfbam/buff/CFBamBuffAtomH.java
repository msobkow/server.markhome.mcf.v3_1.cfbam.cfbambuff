// Description: Java 25 implementation of a Atom history buffer object
...
public class CFBamBuffAtomH extends CFBamBuffValueH
    implements ICFBamAtomH
{
	protected String optionalDbName;

    public CFBamBuffAtomH() {
            super();
		optionalDbName = null;
    }
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamAtom) {
            ICFBamAtom rhs = (ICFBamAtom)obj;
        if (!super.equals(obj)) {
            return( false );
        }
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffAtom ) {
			setAtom( (CFBamBuffAtom)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamAtomH ) {
			setAtom( (ICFBamAtomH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffAtomH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
