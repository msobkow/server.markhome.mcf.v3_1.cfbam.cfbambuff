// Description: Java 25 implementation of a Chain history buffer object
...
public class CFBamBuffChainH
    implements ICFBamChainH, Comparable<Object>, Serializable
{
    protected CFBamBuffChainHPKey pkey;
    ...
    public void setPKey( ICFBamChainHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFBamBuffChainHPKey) {
                this.pkey = (CFBamBuffChainHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFBamBuffChainHPKey");
            }
        }
    }
    ...
    public boolean equals( Object obj ) {
		...
		if (getPKey() != null) {
			...
			if( getRequiredPrevRelationId() != null && !getRequiredPrevRelationId().isNull() ) {
				if( rhs.getRequiredPrevRelationId() != null && !rhs.getRequiredPrevRelationId().isNull() ) {
				...
				if( rhs.getRequiredPrevRelationId() != null && !getRequiredPrevRelationId().isNull()) {
					return( false );
				}
			}
			if( getRequiredNextRelationId() != null && !getRequiredNextRelationId().isNull() ) {
				if( rhs.getRequiredNextRelationId() != null && !rhs.getRequiredNextRelationId().isNull() ) {
				...
				if( rhs.getRequiredNextRelationId() != null && !getRequiredNextRelationId().isNull()) {
					return( false );
				}
			}
            return( true );
    ...
    public String toString() {
        String ret = "<CFBamBuffChainH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
