// Description: Java 25 implementation of a TimestampType buffer
	...
	implements ICFBamTimestampType
{
	...
	public String toString() {
		String ret = "<CFBamBuffTimestampType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
