// Description: Java 25 implementation of a BoolType history buffer object
...
public class CFBamBuffBoolTypeH extends CFBamBuffBoolDefH
    implements ICFBamBoolTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffBoolTypeH() {
            super();
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamBoolType) {
            ICFBamBoolType rhs = (ICFBamBoolType)obj;
        if (!super.equals(obj)) {
            return( false );
        }
        ...
        else if (obj instanceof ICFBamBoolTypeH) {
			if (!super.equals(obj)) {
				return( false );
			}
            ICFBamBoolTypeH rhs = (ICFBamBoolTypeH)obj;
        if (!super.equals(obj)) {
            return( false );
        }
			if( getRequiredSchemaDefId() != null && !getRequiredSchemaDefId().isNull() ) {
        ...
        else if (obj instanceof ICFBamBoolTypeBySchemaIdxKey) {
            ICFBamBoolTypeBySchemaIdxKey rhs = (ICFBamBoolTypeBySchemaIdxKey)obj;
			if( getRequiredSchemaDefId() != null && !getRequiredSchemaDefId().isNull() ) {
				if( rhs.getRequiredSchemaDefId() != null && !rhs.getRequiredSchemaDefId().isNull() ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffBoolType ) {
			setBoolType( (CFBamBuffBoolType)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamBoolTypeH ) {
			setBoolType( (ICFBamBoolTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffBoolTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
