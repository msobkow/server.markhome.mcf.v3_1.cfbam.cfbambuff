...
// Description: Java 25 Default Factory implementation for DelTopDep buffers
...
/*
 *	CFBamBuffDelTopDepFactory implementation of ICFBamDelTopDepFactory for DelTopDep
 */
public class CFBamBuffDelTopDepDefaultFactory
	implements ICFBamDelTopDepFactory
{
	public CFBamBuffDelTopDepDefaultFactory() {
	}

	@Override
	public ICFBamDelTopDepByDelTopDepTblIdxKey newByDelTopDepTblIdxKey() {
		ICFBamDelTopDepByDelTopDepTblIdxKey key =
			new CFBamBuffDelTopDepByDelTopDepTblIdxKey();
		return( key );
	}
	...
	public ICFBamDelTopDepByPrevIdxKey newByPrevIdxKey() {
		ICFBamDelTopDepByPrevIdxKey key =
			new CFBamBuffDelTopDepByPrevIdxKey();
		return( key );
	}
