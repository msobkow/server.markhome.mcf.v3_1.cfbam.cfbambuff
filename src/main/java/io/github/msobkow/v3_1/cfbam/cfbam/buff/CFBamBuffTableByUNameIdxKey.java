// Description: Java 25 implementation of a Table by UNameIdx index key buffer
...
public class CFBamBuffTableByUNameIdxKey
	implements ICFBamTableByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	protected String requiredName;
	public CFBamBuffTableByUNameIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffTableByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
