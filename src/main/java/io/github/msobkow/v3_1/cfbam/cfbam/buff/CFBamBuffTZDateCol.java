// Description: Java 25 implementation of a TZDateCol buffer
	...
	implements ICFBamTZDateCol
{
	...
	public String toString() {
		String ret = "<CFBamBuffTZDateCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
