// Description: Java 25 implementation of a ClearSubDep1 by UNameIdx index key buffer
...
public class CFBamBuffClearSubDep1ByUNameIdxKey
	implements ICFBamClearSubDep1ByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredClearTopDepId;
	protected String requiredName;
	public CFBamBuffClearSubDep1ByUNameIdxKey() {
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredClearTopDepId() != null && !getRequiredClearTopDepId().isNull() ) {
				if( rhs.getRequiredClearTopDepId() != null && !rhs.getRequiredClearTopDepId().isNull() ) {
				...
				if( rhs.getRequiredClearTopDepId() != null && !getRequiredClearTopDepId().isNull()) {
					return( false );
				}
			}
	...
	public String toString() {
		String ret = "<CFBamBuffClearSubDep1ByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
