// Description: Java 25 implementation of a DelDep by DelDepIdx index key buffer
...
public class CFBamBuffDelDepByDelDepIdxKey
	implements ICFBamDelDepByDelDepIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffDelDepByDelDepIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
