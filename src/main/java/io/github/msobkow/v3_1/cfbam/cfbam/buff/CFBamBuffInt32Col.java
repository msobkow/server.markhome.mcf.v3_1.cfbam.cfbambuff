// Description: Java 25 implementation of a Int32Col buffer
	...
	implements ICFBamInt32Col
{
	...
	public String toString() {
		String ret = "<CFBamBuffInt32Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
