// Description: Java 25 implementation of a DelSubDep3 by DelSubDep2Idx index key buffer
...
public class CFBamBuffDelSubDep3ByDelSubDep2IdxKey
	implements ICFBamDelSubDep3ByDelSubDep2IdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamBuffDelSubDep3ByDelSubDep2IdxKey() {
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredDelSubDep2Id() != null && !getRequiredDelSubDep2Id().isNull() ) {
				if( rhs.getRequiredDelSubDep2Id() != null && !rhs.getRequiredDelSubDep2Id().isNull() ) {
				...
				if( rhs.getRequiredDelSubDep2Id() != null && !getRequiredDelSubDep2Id().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public String toString() {
		String ret = "<CFBamBuffDelSubDep3ByDelSubDep2IdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
