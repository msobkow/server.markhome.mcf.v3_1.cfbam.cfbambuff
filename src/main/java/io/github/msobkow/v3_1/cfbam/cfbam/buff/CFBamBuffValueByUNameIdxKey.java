// Description: Java 25 implementation of a Value by UNameIdx index key buffer
...
public class CFBamBuffValueByUNameIdxKey
	implements ICFBamValueByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredScopeId;
	protected String requiredName;
	public CFBamBuffValueByUNameIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffValueByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
