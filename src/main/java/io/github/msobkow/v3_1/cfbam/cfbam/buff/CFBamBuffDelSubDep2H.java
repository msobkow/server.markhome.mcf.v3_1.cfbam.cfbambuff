// Description: Java 25 implementation of a DelSubDep2 history buffer object
...
public class CFBamBuffDelSubDep2H extends CFBamBuffDelDepH
    implements ICFBamDelSubDep2H
{
	protected CFLibDbKeyHash256 requiredDelSubDep1Id;
	protected String requiredName;

    public CFBamBuffDelSubDep2H() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamBuffDelSubDep2H" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
