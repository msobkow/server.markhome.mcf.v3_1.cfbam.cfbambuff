// Description: Java 25 implementation of a TimeType buffer
	...
	implements ICFBamTimeType
{
	...
	public String toString() {
		String ret = "<CFBamBuffTimeType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
