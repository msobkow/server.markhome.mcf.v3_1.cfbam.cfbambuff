// Description: Java 25 implementation of a UInt32Col by TableIdx index key buffer
...
public class CFBamBuffUInt32ColByTableIdxKey
	implements ICFBamUInt32ColByTableIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffUInt32ColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
