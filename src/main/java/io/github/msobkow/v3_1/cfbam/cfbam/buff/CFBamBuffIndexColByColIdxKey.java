// Description: Java 25 implementation of a IndexCol by ColIdx index key buffer
...
public class CFBamBuffIndexColByColIdxKey
	implements ICFBamIndexColByColIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamBuffIndexColByColIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
