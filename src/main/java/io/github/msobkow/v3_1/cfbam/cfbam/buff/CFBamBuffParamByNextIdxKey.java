// Description: Java 25 implementation of a Param by NextIdx index key buffer
...
public class CFBamBuffParamByNextIdxKey
	implements ICFBamParamByNextIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalNextId;
	public CFBamBuffParamByNextIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffParamByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
