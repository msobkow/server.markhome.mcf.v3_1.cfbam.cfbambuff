// Description: Java 25 implementation of a NmTokenType buffer
...
public class CFBamBuffNmTokenType
	extends CFBamBuffNmTokenDef
	implements ICFBamNmTokenType
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

	public CFBamBuffNmTokenType() {
		super();
		requiredSchemaDefId = CFLibDbKeyHash256.fromHex( ICFBamNmTokenType.SCHEMADEFID_INIT_VALUE.toString() );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokenType ) {
			ICFBamNmTokenType rhs = (ICFBamNmTokenType)obj;
		...
		else if( obj instanceof ICFBamNmTokenTypeH ) {
			ICFBamNmTokenTypeH rhs = (ICFBamNmTokenTypeH)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamNmTokenTypeBySchemaIdxKey ) {
			ICFBamNmTokenTypeBySchemaIdxKey rhs = (ICFBamNmTokenTypeBySchemaIdxKey)obj;
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
	...
	public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffNmTokenType ) {
			setNmTokenType( (CFBamBuffNmTokenType)src );
		}
		else {
	...
	public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamNmTokenTypeH ) {
			setNmTokenType( (ICFBamNmTokenTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	public String toString() {
		String ret = "<CFBamBuffNmTokenType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
