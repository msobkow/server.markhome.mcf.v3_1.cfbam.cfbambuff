// Description: Java 25 implementation of a Int16Def history buffer object
...
public class CFBamBuffInt16DefH extends CFBamBuffAtomH
    implements ICFBamInt16DefH
{
	protected Short optionalInitValue;
	protected Short optionalMinValue;
	protected Short optionalMaxValue;

    public CFBamBuffInt16DefH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffInt16Def ) {
			setInt16Def( (CFBamBuffInt16Def)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffInt16DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
