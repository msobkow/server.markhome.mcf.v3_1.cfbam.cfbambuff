// Description: Java 25 implementation of a TZTimeType history buffer object
...
public class CFBamBuffTZTimeTypeH extends CFBamBuffTZTimeDefH
    implements ICFBamTZTimeTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffTZTimeTypeH() {
            super();
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFBamTZTimeType) {
            ICFBamTZTimeType rhs = (ICFBamTZTimeType)obj;
        if (!super.equals(obj)) {
            return( false );
        }
        ...
        else if (obj instanceof ICFBamTZTimeTypeH) {
			if (!super.equals(obj)) {
				return( false );
			}
            ICFBamTZTimeTypeH rhs = (ICFBamTZTimeTypeH)obj;
        if (!super.equals(obj)) {
            return( false );
        }
			if( getRequiredSchemaDefId() != null && !getRequiredSchemaDefId().isNull() ) {
        ...
        else if (obj instanceof ICFBamTZTimeTypeBySchemaIdxKey) {
            ICFBamTZTimeTypeBySchemaIdxKey rhs = (ICFBamTZTimeTypeBySchemaIdxKey)obj;
			if( getRequiredSchemaDefId() != null && !getRequiredSchemaDefId().isNull() ) {
				if( rhs.getRequiredSchemaDefId() != null && !rhs.getRequiredSchemaDefId().isNull() ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffTZTimeType ) {
			setTZTimeType( (CFBamBuffTZTimeType)src );
		}
		else {
    ...
    public void set( ICFBamValueH src ) {
		if( src instanceof ICFBamTZTimeTypeH ) {
			setTZTimeType( (ICFBamTZTimeTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
    ...
    public String toString() {
        String ret = "<CFBamBuffTZTimeTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
