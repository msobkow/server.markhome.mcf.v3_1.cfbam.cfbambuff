// Description: Java 25 implementation of a Param by UNameIdx index key buffer
...
public class CFBamBuffParamByUNameIdxKey
	implements ICFBamParamByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamBuffParamByUNameIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamBuffParamByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
