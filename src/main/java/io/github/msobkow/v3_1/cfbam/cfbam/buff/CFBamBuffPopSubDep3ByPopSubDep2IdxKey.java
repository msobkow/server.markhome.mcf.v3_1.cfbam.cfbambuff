// Description: Java 25 implementation of a PopSubDep3 by PopSubDep2Idx index key buffer
...
public class CFBamBuffPopSubDep3ByPopSubDep2IdxKey
	implements ICFBamPopSubDep3ByPopSubDep2IdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredPopSubDep2Id;
	public CFBamBuffPopSubDep3ByPopSubDep2IdxKey() {
	...
	public boolean equals( Object obj ) {
		if( obj == null ) {
			...
			if( getRequiredPopSubDep2Id() != null && !getRequiredPopSubDep2Id().isNull() ) {
				if( rhs.getRequiredPopSubDep2Id() != null && !rhs.getRequiredPopSubDep2Id().isNull() ) {
				...
				if( rhs.getRequiredPopSubDep2Id() != null && !getRequiredPopSubDep2Id().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public String toString() {
		String ret = "<CFBamBuffPopSubDep3ByPopSubDep2IdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
