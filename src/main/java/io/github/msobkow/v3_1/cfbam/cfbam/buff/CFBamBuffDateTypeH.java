// Description: Java 25 implementation of a DateType history buffer object
...
public class CFBamBuffDateTypeH extends CFBamBuffDateDefH
    implements ICFBamDateTypeH
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;

    public CFBamBuffDateTypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof CFBamBuffDateType ) {
			setDateType( (CFBamBuffDateType)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamBuffDateTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
