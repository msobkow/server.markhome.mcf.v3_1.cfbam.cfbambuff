// Description: Java 25 implementation of a UInt64Type buffer
	...
	implements ICFBamUInt64Type
{
	...
	public String toString() {
		String ret = "<CFBamBuffUInt64Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
