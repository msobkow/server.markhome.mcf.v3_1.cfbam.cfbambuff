// Description: Java 25 implementation of a TZTimestampDef buffer
	...
	implements ICFBamTZTimestampDef
{
	...
	public String toString() {
		String ret = "<CFBamBuffTZTimestampDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
